  ...
  try {
    ...
    try {
      ...
      response = await groq.chat.completions.create({
        ...
        messages: [
          { role: 'system', content: 'You are a professional travel planner. Provide a flawless JSON object matching requirements exactly.' },
      ...
      console.warn("Primary model failed, retrying with fallback:", primaryErr.message);
      // Fallback model
      response = await groq.chat.completions.create({
